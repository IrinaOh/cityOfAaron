...
public class CropData implements Serializable{
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + this.acresOwned;
        hash = 37 * hash + this.cropYield;
        hash = 37 * hash + this.wheatInStore;
        hash = 37 * hash + this.numberWhoDied;
        hash = 37 * hash + this.newPeople;
        hash = 37 * hash + this.harvest;
        hash = 37 * hash + this.harvestAfterOffering;
        hash = 37 * hash + this.offering;
        hash = 37 * hash + this.offeringBushels;
        hash = 37 * hash + this.peopleFed;
        hash = 37 * hash + this.acresPlanted;
        hash = 37 * hash + this.numStarved;
        hash = 37 * hash + this.eatenByRats;
        hash = 37 * hash + this.wheatForPeople;
        return hash;
    }
